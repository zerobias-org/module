...
```bash
# Standard pattern
MEMORY_PATH=".claude/.localmemory/${workflow}-${moduleId}"

# Examples:
# .claude/.localmemory/create-module-github-github/
# .claude/.localmemory/add-operation-github-github/
# .claude/.localmemory/update-module-amazon-aws-s3/
```
...
# Construct path
MEMORY_PATH=".claude/.localmemory/${WORKFLOW}-${MODULE_ID}"
...
Always construct from parameters.
