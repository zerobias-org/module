---
name: api-critical-12
description: 12 critical API specification rules causing immediate task failure. Use when designing, reviewing, or validating OpenAPI specifications to ensure compliance with mandatory standards.
---
...
- Full API specification rules: @.claude/skills/api-spec-core/SKILL.md, @.claude/skills/api-operations/SKILL.md, @.claude/skills/api-schemas/SKILL.md, @.claude/skills/api-schema-patterns/SKILL.md, @.claude/skills/api-standards/SKILL.md
- Gate 1 validation: @.claude/skills/gate-api-spec/SKILL.md
