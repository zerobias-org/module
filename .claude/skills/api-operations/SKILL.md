---
name: api-operations
description: API operation design patterns and best practices. Use when defining endpoints, operation IDs, parameters, or request/response structures in OpenAPI specifications.
---
