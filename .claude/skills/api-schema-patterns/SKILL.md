...
description: Schema design patterns and composition strategies. Use when designing reusable schemas, inheritance structures, or complex data models in OpenAPI.
---
...
- Core Rules: @.claude/skills/api-spec-core/SKILL.md
- Critical 12 Rules: @.claude/skills/api-critical-12/SKILL.md
- Schema Rules: @.claude/skills/api-schemas/SKILL.md
