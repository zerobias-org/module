---
name: api-schemas
description: Comprehensive schema definition guidelines and standards. Use when creating or validating schema definitions in OpenAPI components section.
---
...
See @.claude/skills/type-mapping/SKILL.md for complete format reference.
