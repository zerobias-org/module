---
name: api-spec-core
description: Core OpenAPI specification rules and foundation principles. Use when starting new API specifications or ensuring basic compliance with OpenAPI standards.
---
