...
description: HTTP client implementation patterns for module clients. Use when implementing Client classes, connection management, or HTTP request infrastructure.
---
