---
name: http-client
description: HTTP client patterns and request/response handling. Use when implementing HTTP requests, configuring clients, or handling API communication.
---
...
See @.claude/skills/error-handling/SKILL.md for complete error mapping reference.
...
**Critical rules:**
- ALWAYS map to core error types (see @.claude/skills/error-handling/SKILL.md)
...
See @.claude/skills/nock-mocking/SKILL.md for complete mocking patterns.
