---
name: output-naming
description: Output file and artifact naming conventions. Use when creating files, naming classes, or following repository naming standards.
---
...
```json
{
  ...
  "moduleIdentifier": "github-github",
  "yeomanCommand": "yo @zerobias-org/hub-module ...",
  "validations": {
...
```json
{
  ...
  "testFiles": {
    "connectionUnit": "test/unit/ConnectionTest.test.ts",
    "repositoryUnit": "test/unit/RepositoryProducerTest.test.ts",
    "connectionE2e": "test/e2e/connection.test.ts",
    "repositoryE2e": "test/e2e/repository.test.ts",
    "e2eConstants": "test/e2e/constants.ts"
  },
  "testExecution": {
    "unitCommand": "zbb test --slot local",
    "e2eCommand": "zbb testDirect --slot local",
    "exitCode": 0,
    "totalTests": 12,
    "passed": 12,
    "failed": 0
...
```json
{
  ...
  "build": {
    "command": "zbb gate --slot local",
    "exitCode": 0,
    "outputFiles": ["dist/index.js", "dist/index.d.ts", "gate-stamp.json"]
  },
  "gate6": {
    "status": "passed",
    "validations": {
