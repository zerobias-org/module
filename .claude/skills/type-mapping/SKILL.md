---
name: type-mapping
description: Type conversion and mapping reference between API types and core types. Use when mapping types, converting data formats, or applying core type patterns.
---
