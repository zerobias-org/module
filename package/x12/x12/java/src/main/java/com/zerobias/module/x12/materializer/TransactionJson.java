...
public final class TransactionJson {
     ...
     * ISA13 is part of it because one file may carry several interchanges, and GS06/ST02
     * are only unique within an interchange (senders routinely restart them at 1/0001).
     */
