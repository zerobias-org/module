-- FROZEN: the buffer schema as shipped before the object graph (dev @ 902c01f), when the
-- typed document lived in transactions.mapped_json. LegacyBufferUpgradeTest builds a buffer
-- from this to prove an upgraded container still ingests. Never edit it to match schema.sql.
